...
CREATE TABLE `t_sku` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='SKU';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_sku` VALUES (1,1,'3','啊啊啊',100,80,'一斤',280,NULL,4.6667),(2,1,'4','呃呃呃',100,80,'一箱',320,NULL,4.5),(3,1,'5','呜呜呜',100,80,'一箱',300,NULL,NULL),(4,1,'3','啊啊啊aaa',100,80,'两斤',280,NULL,NULL),(5,1,'7','啊啊啊aaa',100,80,'两斤',280,NULL,NULL);
...
-- Dump completed on 2015-10-09 21:40:26
