...
INSERT INTO `t_brand` VALUES (4,'都乐','Dole（都乐）食品公司于1851年在夏威夷岛成立，发展至今已成为世界上最大的、品质最好的新鲜水果、蔬菜的生产、销售跨国集团之一'),(5,'佳沛','新西兰奇异果知名品牌');
...
CREATE TABLE `t_category` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='品类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `t_category_product` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='品类品牌关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_file` VALUES (6,'奇异果.jpg',0,'static/upload/efa7bfcc-5c60-499a-8be3-98df0682d038-奇异果.jpg','2015-09-20 15:36:57');
...
INSERT INTO `t_product` VALUES (3,'特大佳沛新西兰绿奇异果',1,'特大佳沛新西兰绿奇异果','2015-09-20 15:36:58',NULL,6,5);
...
CREATE TABLE `t_sku` (
  `id` int(11) NOT NULL auto_increment,
  `pruductId` int(11) NOT NULL COMMENT '所属产品',
  `name` varchar(45) NOT NULL,
  `price` double NOT NULL COMMENT '价格',
  `standard` varchar(45) NOT NULL COMMENT '规格',
...
INSERT INTO `t_user` VALUES (1,'huoyao','huoyao','霍耀1',1,1,'2015-05-06 15:25:30',1,0,'15828059647','519034857@qq.com'),(2,'admin','admin','管理员',1,1,'2015-05-06 15:25:30',1,0,'15828059647','519034857@qq.com'),(3,'111','1111','111',1,1,'2015-09-20 13:07:12',1,0,'111111','1111111@qq.com');
...
-- Dump completed on 2015-09-20 23:56:00
